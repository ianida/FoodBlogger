...
<body>
    <div>
        <img src="<?php echo BASE_URL; ?>assets/img/pizza.png" style="position: absolute;top:8%;">
    </div>
    <div class="container menu-link">
        <a href="#indexbox" id="scroll">
    ...
    <div class="indexbox" id="indexbox">
        <strong>
            ...
            <!--<h1>Contact Us</h1>
            <hr>
            <p>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Phone No.:9841000000</p>-->
        </strong>
    </div>
    <!-- <div class="footer">
        <p id="demo"></p>
